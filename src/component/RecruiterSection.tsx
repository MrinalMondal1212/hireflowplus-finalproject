      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative group">
          ...
          <div className="relative space-y-4">
            {/* Card 1: Dashboard */}
            <div className="bg-white/[0.03] border border-white/10 p-5 rounded-2xl backdrop-blur-xl translate-x-4 hover:translate-x-0 transition-transform duration-500">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden">
                    <div className="w-[75%] h-full bg-[var(--primary)] rounded-full shadow-[0_0_10px_var(--primary)]"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/[0.06] border border-[var(--primary)]/30 p-5 rounded-2xl backdrop-blur-xl z-10 relative shadow-2xl">
              <div className="flex items-start gap-4">
            ...
            {/* Card 3: Scheduling */}
            <div className="bg-white/[0.03] border border-white/10 p-5 rounded-2xl backdrop-blur-xl translate-x-8 hover:translate-x-0 transition-transform duration-500">
              <div className="flex items-start gap-4">
