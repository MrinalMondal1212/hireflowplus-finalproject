      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <span className="text-var(--primary) font-semibold tracking-widest uppercase text-sm">
              For Recruiters
            </span>
            ...
            <p className="text-[oklch(0.80_0_0)] text-lg md:text-xl leading-relaxed max-w-lg">
              Post jobs, track applicants, and discover top talent with
              AI-powered matching. HireFlow+ provides everything you need to
              build elite teams.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 text-center">
            <RainbowButton
              ...
              className="px-8 py-4 rounded-xl border-none"
            >
            ...
            <TextType className="text-white"
              text={[
                "Welcome to HireFlow+",
                "Hire top developers faster",
                "Build elite teams with AI",
              ]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-var(--primary) text-xs font-bold bg-var(--primary)/10 px-2 py-0.5 rounded">
                      98% Match
                    </span>
                  </div>
                  <p className="text-xs text-white/40 italic">
                    "Top candidate identified for Senior Lead role"
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <div className="w-8 h-8 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-[10px]">
                      JD
                    </div>
                    <div className="w-8 h-8 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-[10px]">
                      AS
                    </div>
                    <div className="w-8 h-8 rounded-full bg-var(--primary)/20 border border-var(--primary)/50 flex items-center justify-center text-[10px] text-var(--primary)">
                      +3
                    </div>
                  </div>
                </div>
