...
const Login = () => {
  ...
  const handelLogin = async () => {
    ...
    try {
      ...
      // ONLY USER LOGIN
      if (role !== "user") {
        alert("Please login from recruiter portal");
        return;
      }
    ...
    <div className="min-h-screen bg-[oklch(0.12_0.01_250)] flex items-center justify-center px-4 font-sans">
      <div className="w-full max-w-md space-y-8 p-10 rounded-md border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl">
          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-10 pr-12 py-3 bg-black/40 border border-white/10 rounded-md text-white outline-none focus:ring-1 focus:ring-primary"
              />
        ...
        <div className="text-center text-sm">
          <Link href="/user/register" className="text-gray-400 hover:text-white">
